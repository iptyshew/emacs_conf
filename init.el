...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(clang-format multi-compile exec-path-from-shell company-rtags cmake-ide helm-projectile cmake-mode sr-speedbar powerline magit helm markdown-mode rtags company projectile helm-rtags)))
