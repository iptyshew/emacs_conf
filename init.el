...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(exec-path-from-shell company-rtags cmake-ide helm-projectile cmake-mode sr-speedbar powerline magit helm markdown-mode rtags company projectile helm-rtags)))
